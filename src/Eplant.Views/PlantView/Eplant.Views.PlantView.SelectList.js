(function() {
	...
	/**
		...
		* @constructor
	*/
	Eplant.Views.PlantView.SelectList = function(speciesView) {
		/* Attributes */
		this.speciesView = speciesView;		// PlantView that owns this SelectList object
	...
	*/
	Eplant.Views.PlantView.SelectList.prototype.createDOM = function() {
		...
		var eventListener = new ZUI.EventListener("load-plants", Eplant, function(event, eventData, listenerData) {
			...
			/* Finish loading */
			//listenerData.selectList.PlantView.loadFinish();
			}, {
			selectList: this
		});
	...
	Eplant.Views.PlantView.SelectList.prototype.loadViewNames = function(view) {
		var dfd = $.Deferred();
		if(this.choices&&this.choices.length>0){
			...
			$.getJSON( "data/plant/viewNames.json", $.proxy(function( data ) {
				...
				for (var n = 0; n < eFPViews.length; n++) {
					...
					/* Create Choice */
					var choice = new Eplant.Views.PlantView.SelectList.Choice(view, this);
	...
	/**
		...
		* @return {Eplant.Views.PlantView.SelectList.Choice} Choice associated with the specified Species.
	*/
	Eplant.Views.PlantView.SelectList.prototype.getChoiceByView = function(view) {
	...
	*/
	Eplant.Views.PlantView.SelectList.prototype.draw = function() {
	...
	*/
	Eplant.Views.PlantView.SelectList.prototype.show = function() {
		...
		if(this.choices.length===0){
			var expEvent = new ZUI.Event("load-plants", Eplant, null);
	...
	Eplant.Views.PlantView.SelectList.prototype.getSidebar = function(order) {
	...
	Eplant.Views.PlantView.SelectList.prototype.updateSideBar = function(order) {
	...
	*/
	Eplant.Views.PlantView.SelectList.prototype.hide = function() {
	...
	*/
	Eplant.Views.PlantView.SelectList.prototype.remove = function() {
