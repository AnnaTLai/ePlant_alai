  ...
  */
  ...
  Eplant.Views.CellView.prototype.generateCitation = function() {
    this.citation='<h2>Citation and Experiment Information for this View</h2><br>';
      this.citation += "The data come from Hooper CM, Castleden IR, Tanz SK, Aryamanesh N, Millar AH (2017). SUBA4: the interactive data analysis centre for Arabidopsis subcellular protein locations. Nucleic Acids Res. 45(D1):D1064-D1074.<br><br>The SUBA4 database contains information on the computationally predicted and experimentally documented subcellular localization of many Arabidopsis proteins. We apply the formula indicated in the Material and Methods section of Winter et al. 2007 (doi: 10.1371/journal.pone.0000718) to generate a confidence score for each distinct subcellular compartment or region, with experimentally-determined localizations being weighted five times more than predicted ones. The higher the confidence score for a given subcellular compartment, the more intense the red colour in the Cell eFP Browser output. <br><br> See further details at SUBA4: <a target='_blank' href='http://suba.live/factsheet.html?id="+this.geneticElement.identifier+"'>http://suba.live/factsheet.html?id="+this.geneticElement.identifier+"</a>";
