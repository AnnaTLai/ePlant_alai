(function() {
	...
	*/
    ...
    // console.log('Heatmap view done loading')
		// this.loadFinish(); //BEN CHANGED
	...
	*/
    ...
    //this.loadFinish(); //BEN CHANGED, ensures that link from home view works
	};
  ...
  // /**
	// 	* listens to events for calling load finish
	// 	*
	// */
  // Eplant.Views.HeatMapView.prototype.remove = function() {
