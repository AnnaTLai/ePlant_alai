  ...
  Eplant.Views.GeneInfoView.prototype.loadData = function() {
    $.when(Eplant.Views.GeneInfoView.Params.htmlPage).then($.proxy(function( res ) {
      ...
      var getGeneSummary = $.ajax({
        type: 'GET',
        url: '//bar.utoronto.ca/webservices/bar_araport/gene_summary_by_locus.php?locus=' + this.geneticElement.identifier,
        dataType: 'json',
      ...
      var getGeneStructure = $.ajax({
        type: "GET",
        dataType: "json",
        url: '//bar.utoronto.ca/webservices/bar_araport/gene_structure_by_locus.php?locus='+this.geneticElement.identifier,
        success: $.proxy(function(data) {
          ...
          for(var i =0;i<geneModelFeatures.length;i++){
            ...
            if (geneModelFeatures[i].uniqueID == (this.geneticElement.identifier + ".1")) {
          ...
          var getGenomeSequence = $.ajax({
            type: "GET",
            dataType: "json",
            url: '//bar.utoronto.ca/webservices/bar_araport/get_sequence_by_identifier.php?locus=' + this.geneticElement.identifier,
            success: $.proxy(function(data) {
