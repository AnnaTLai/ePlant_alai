	...
	Eplant.Views.GeneInfoView.prototype.loadData = function() {
		$.when(Eplant.Views.GeneInfoView.Params.htmlPage).then($.proxy(function( res ) {
			...
			var getGeneSummary = $.ajax({
				type: 'GET',
				url: '//bar.utoronto.ca/webservices/araport/api/bar_gene_summary_by_locus.php?locus=' + this.geneticElement.identifier,
				dataType: 'json',
				success: $.proxy(function(data) {
					...
					var getGeneStructure = $.ajax({
						type: "GET",
						dataType: "json",
						url: '//bar.utoronto.ca/webservices/araport/api/bar_araport11_gene_structure_by_locus.php?locus='+this.geneticElement.identifier,
						success: $.proxy(function(data) {
			...
			var getGenomeSequence = $.ajax({
				type: "GET",
				dataType: "json",
				url: '//bar.utoronto.ca/webservices/araport/api/bar_get_sequence_by_identifier.php?identifier=' + this.geneticElement.identifier,
				success: $.proxy(function(data) {
