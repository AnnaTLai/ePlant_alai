    ...
    this.Xhrs.loadsvgXhr = $.ajax({
      ...
      success: $.proxy(function(data) {
        var map = {
          ...
          "#Interaction_viewer_button": "The Interactions viewer displays protein interactors for the currently selected gene product from our database of ~80k predicted and ~100k confirmed protein interactions, and 2.8M protein-DNA interactions.",
          "#Pathway_viewer_button": "The Pathway viewer displays biological pathways associated with the selected gene.",
